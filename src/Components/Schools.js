    ...
    <Container maxW={'7xl'}>
      ...
      <Flex
        ...
        <Card
          ...
          description={"Students who receive school-based mental health support."}
          color={'green.500'}
        />
        <Card
          number={"13%"}
          heading={"APA, 2019"}
          description={"Students receiving mental health support and increase in academic success."}
          color={'green.500'}
        />
        <Card
          number={"1 in 7"}
      ...
      <Stack
        ...
        <Stack flex={1} spacing={{ base: 5, md: 10 }}>
          ...
          <Text fontSize={{ base: "14", lg: "24" }} color={"gray.700"}>
            We equip parents with the tools to support their child's emotional growth,
